export default {
  ...
  sidebar: {
    ...
    connected: 'Verbunden',
    disconnected: 'Getrennt',
    updateTip: 'Fuhren Sie "yi-web-ui update" im Terminal aus, um zu aktualisieren',
  ...
  runtimeVersions: {
    ...
    deleteRuntimeConfirm: 'Yi Runtime {version} löschen?',
    ...
    activateSuccess: 'Versionsauswahl gespeichert. Starten Sie Yi Studio neu, um sie zu verwenden.',
    jobStatus: {
  ...
  chat: {
    ...
    contextEditHint: 'Häufige Werte: 256k (Yi-Standard), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Starten Sie eine Konversation mit Yi Agent',
    ...
    hermesHistory: 'Yi-Verlauf',
    historyScopeHint: 'Schreibgeschützte Yi-Verlaufssitzungen des aktuellen Profils, nach Quelle gruppiert.',
    ...
    searchScope: 'Suchbereich: nur lokale Web-UI-Sitzungsdatenbank; schreibgeschützte Yi-Verlaufssitzungen sind nicht enthalten.',
...
jobTriggered: 'Job ausgelost',
  ...
  skills: {
    ...
    writeApprovalDescription: 'Freigeben oder ablehnen, was Yi Agent fuer Speicher und Skills vorgemerkt hat.',
    writeApprovalRefresh: 'Aktualisieren',
    writeApprovalEmpty: 'Keine ausstehenden Schreibvorgaenge.',
    writeApprovalUnsupported: 'Diese Yi-Agent-Version unterstuetzt keine Schreibfreigaben. Aktualisiere Yi Agent, um diese Funktion zu nutzen.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Aktualisieren',
    notice: 'Schreibgeschütztes Inventar erkennbarer Yi-Plugin-Manifeste. Discovery-Metadaten werden gelesen, ohne Plugin-Code zu laden. Verwaltungsaktionen bleiben in v1 im CLI; Änderungen gelten für neue Yi-Sitzungen.',
  ...
  models: {
    ...
    copilotAddDetected: 'Auf diesem Rechner wurde ein GitHub Copilot OAuth-Token erkannt. Klicken Sie auf „Hinzufügen", um Copilot in Yi zu aktivieren.',
    copilotAddSourceEnv: 'Quelle: ~/.yi/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Quelle: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Quelle: VS Code Copilot-Erweiterung (apps.json)',
    copilotDeleteHintEnv: 'Dies löscht COPILOT_GITHUB_TOKEN in ~/.yi/.env. Andere Tools sind nicht betroffen.',
    copilotDeleteHintGhCli: 'Copilot wird aus Yi ausgeblendet. Ihre gh CLI-Anmeldung bleibt erhalten — `gh auth status` zeigt weiterhin als angemeldet.',
    copilotDeleteHintAppsJson: 'Copilot wird aus Yi ausgeblendet. Ihre VS Code Copilot-Erweiterung bleibt angemeldet.',
    ...
    visibilityHint: 'Wirkt sich nur auf Modellauswahl und Modellseite der Web UI aus. Die provider/model-Konfiguration der Yi CLI wird nicht geändert; Aufrufe verwenden weiterhin die ursprüngliche Modell-ID.',
    ...
    aliasHint: 'Ändert nur den Anzeigenamen in der Web UI. Yi erhält weiterhin die ursprüngliche Modell-ID.',
  ...
  profiles: {
    ...
    rename: 'Umbenennen',
    delete: 'Loschen',
    switchTo: 'Yi Profile wechseln',
    switchConfirm: 'Dies fuehrt `Yi Profile use {name}` aus und aendert das aktive Yi CLI Profile. Fortfahren?',
    switchSuccess: 'Aktives Yi Profile ist jetzt "{name}"',
    switchFailed: 'Yi Profile konnte nicht gewechselt werden. Das Gateway muss eventuell manuell neu gestartet werden.',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Legt fest, welche lokalen Yi-Profile-Gateways die Web UI beim Start startet. Diese Einstellung wird in der Web-UI-Konfiguration gespeichert, nicht in der profile config.yaml.',
    ...
    session: {
      ...
      memoryWriteApprovalHint: 'Yi-Agent-Speicherschreibungen vor dem Speichern zur Freigabe vormerken.',
      skillsWriteApproval: 'Skill-Schreibungen pruefen',
      skillsWriteApprovalHint: 'Yi-Agent-Skill-Aenderungen vor dem Speichern zur Freigabe vormerken.',
      writeApprovalTitle: 'Ausstehende Schreibfreigaben',
      writeApprovalDescription: 'Freigeben oder ablehnen, was Yi Agent fuer Speicher und Skills vorgemerkt hat.',
      writeApprovalRefresh: 'Aktualisieren',
      writeApprovalEmpty: 'Keine ausstehenden Schreibvorgaenge.',
  ...
  codingAgents: {
    ...
    codexDescription: "OpenAI CLI und Yi openai-codex Anbieter-Flow fur Repository-Aufgaben.",
    ...
    installFailedHermesHint: "Installation fehlgeschlagen. Bitte Yi, es fur dich zu installieren.",
    ...
    notes: {
      ...
      codexAuth: "Fugt Yi-verwaltete OpenAI Codex OAuth-Zugangsdaten hinzu.",
  ...
  platform: {
    ...
    weixinTokenHint: 'Von Weixin-CLI QR-Anmeldung (yi weixin)',
    accountId: 'Konto-ID',
  ...
  skillsUsage: {
    title: 'Skill-Nutzung',
    subtitle: 'Skill-Ladevorgänge und -Bearbeitungen aus Yi-Sitzungen verfolgen',
    refresh: 'Aktualisieren',
  ...
  changelog: {
    ...
    new_0_6_21_7: 'Chat-, Group-Chat- und Workflow-Header sind besser ausgerichtet; Xiao Fang He zeigt sold out; der BSL-Scope ist klarer; /learn Planung ist dokumentiert; alter Yi proxy Code wurde entfernt',
    ...
    new_0_6_18_2: 'Yi Studio MCP ist in fokussierte api-, devices- und use-Toolsets aufgeteilt, mit neuen Session-, Modell-, Chat-Run- und Ops-Aktionen',
    ...
    new_0_6_18_6: 'Desktop- und Runtime-Setup sind sicherer mit Unicode-sicherer Windows-PATH-Registrierung, Yi Agent 0.17.0 Runtime-Publishing, mobiler PWA-Metadata und mehreren Profile/Auth-Recovery-Fixes',
    ...
    new_0_6_13_5: 'Desktop-Updates sind verlaesslicher: Windows-Upgrades schliessen alte Yi-Studio-Prozesse, pruefen zuerst Cloudflare und behalten GitHub als Fallback-Feed',
