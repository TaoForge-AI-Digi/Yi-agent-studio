...
import WorkflowAgentNode from '@/components/yi/workflow/WorkflowAgentNode.vue'
import FolderPicker from '@/components/yi/chat/FolderPicker.vue'
import ChatInput from '@/components/yi/chat/ChatInput.vue'
import MessageList from '@/components/yi/chat/MessageList.vue'
import ProfileAvatar from '@/components/yi/profiles/ProfileAvatar.vue'
...
import { uploadRuntimeFiles } from '@/api/yi/files'
import {
...
} from '@/api/yi/workflow-socket'
import { fetchSkills } from '@/api/yi/skills'
import { fetchSession } from '@/api/yi/sessions'
import { inferCodingAgentApiMode, normalizeCodingAgentApiMode } from '@/api/coding-agents'
import { buildWorkflowSkillOptions, workflowAgentToSkillTarget } from '@/utils/yi/workflow-skills'
import type {
  WorkflowAgentNodeData,
  WorkflowAgentNodeEditableData,
  WorkflowNodeStatus,
  WorkflowSelectOption,
} from '@/components/yi/workflow/types'
import type { AvailableModelGroup } from '@/api/yi/system'
