export default {
  ...
  sidebar: {
    ...
    connected: 'Conectado',
    disconnected: 'Desconectado',
    updateTip: 'Ejecuta "yi-web-ui update" en la terminal para actualizar',
  ...
  runtimeVersions: {
    ...
    deleteRuntimeConfirm: '¿Eliminar Yi Runtime {version}?',
    ...
    activateSuccess: 'Selección de versión guardada. Reinicia Yi Studio para usarla.',
    jobStatus: {
      queued: 'En cola',
  ...
  chat: {
    ...
    contextEditHint: 'Valores comunes: 256k (Yi predeterminado), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Inicia una conversacion con Yi Agent',
    ...
    hermesHistory: 'Historial de Yi',
    historyScopeHint: 'Sesiones del historial de Yi del perfil actual, de solo lectura y agrupadas por origen.',
    ...
    searchScope: 'Alcance de búsqueda: solo base de datos local de sesiones de Web UI; no incluye sesiones históricas Yi de solo lectura.',
...
jobTriggered: 'Job ejecutado',
  ...
  skills: {
    ...
    writeApprovalDescription: 'Aprueba o rechaza escrituras de memoria y skills preparadas por Yi Agent.',
    writeApprovalRefresh: 'Actualizar',
    writeApprovalEmpty: 'No hay escrituras pendientes.',
    writeApprovalUnsupported: 'Esta version de Yi Agent no admite revision de escrituras. Actualiza Yi Agent para usar esta funcion.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualizar',
    notice: 'Inventario de solo lectura de manifests de plugins Yi detectables. Los metadatos de descubrimiento se leen sin cargar código de plugins. En v1, la gestión permanece en CLI; los cambios se aplican en nuevas sesiones Yi.',
  ...
  models: {
    ...
    copilotAddDetected: 'Se detectó un token OAuth de GitHub Copilot en este equipo. Haz clic en Agregar para habilitar Copilot en Yi.',
    copilotAddSourceEnv: 'Origen: ~/.yi/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Origen: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Origen: extensión Copilot de VS Code (apps.json)',
    copilotDeleteHintEnv: 'Esto borrará COPILOT_GITHUB_TOKEN en ~/.yi/.env. Otras herramientas no se verán afectadas.',
    copilotDeleteHintGhCli: 'Copilot se ocultará de Yi. Tu sesión de gh CLI no se verá afectada — `gh auth status` seguirá mostrando que estás conectado.',
    copilotDeleteHintAppsJson: 'Copilot se ocultará de Yi. La extensión Copilot de VS Code seguirá conectada.',
    ...
    visibilityHint: 'Solo afecta al selector de modelos y a la página de modelos de Web UI. No modifica la configuración provider/model de Yi CLI; las llamadas siguen usando el ID original del modelo.',
    ...
    aliasHint: 'Solo cambia el nombre visible en Web UI. Yi sigue recibiendo el ID original del modelo.',
    aliasEdit: 'Renombrar',
  ...
  profiles: {
    ...
    rename: 'Renombrar',
    delete: 'Eliminar',
    switchTo: 'Cambiar Yi Profile',
    switchConfirm: 'Esto ejecutara `Yi Profile use {name}` y cambiara el active profile de Yi CLI. Continuar?',
    switchSuccess: 'Yi active profile cambiado a "{name}"',
    switchFailed: 'Error al cambiar Yi Profile. Es posible que la pasarela necesite un reinicio manual.',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Controla qué gateways de perfiles Yi locales inicia la Web UI al arrancar. Se guarda en la configuración de la Web UI, no en el config.yaml del perfil.',
      ...
      managementHint: 'Requiere Yi Agent 0.17.0 o posterior. Al activarlo, Web UI escribe multiplex_profiles para que el gateway default sirva todos los perfiles; otros perfiles no pueden configurar entradas de mensajeria separadas como Feishu, Weixin o QQBot. Al desactivarlo elimina esa configuración.',
    ...
    session: {
      ...
      memoryWriteApprovalHint: 'Preparar las escrituras de memoria de Yi Agent para aprobacion antes de guardarlas.',
      skillsWriteApproval: 'Revisar escrituras de skills',
      skillsWriteApprovalHint: 'Preparar los cambios de skills de Yi Agent para aprobacion antes de guardarlos.',
      writeApprovalTitle: 'Escrituras pendientes de revision',
      writeApprovalDescription: 'Aprueba o rechaza escrituras de memoria y skills preparadas por Yi Agent.',
      writeApprovalRefresh: 'Actualizar',
      writeApprovalEmpty: 'No hay escrituras pendientes.',
  ...
  codingAgents: {
    ...
    codexDescription: "CLI de OpenAI y flujo del proveedor openai-codex de Yi para tareas de repositorio.",
    copyCommand: "Copiar",
    commandCopied: "Comando copiado",
    ...
    installFailedHermesHint: "La instalación falló. Pide a Yi que lo instale por ti.",
    ...
    notes: {
      ...
      codexAuth: "Agrega credenciales OAuth de OpenAI Codex gestionadas por Yi.",
  ...
  platform: {
    ...
    weixinTokenHint: 'Desde el inicio de sesion QR de la CLI de weixin (yi weixin)',
  ...
  skillsUsage: {
    ...
    subtitle: 'Sigue las cargas y ediciones de habilidades en sesiones de Yi',
    refresh: 'Actualizar',
  ...
  changelog: {
    ...
    new_0_6_21_7: 'Los headers de chat, group chat y workflow estan mejor alineados; Xiao Fang He muestra sold out; el alcance BSL queda mas claro; se documento el plan /learn; se elimino el proxy Yi obsoleto',
    ...
    new_0_6_18_2: 'Yi Studio MCP se divide en toolsets api, devices y use, con nuevas acciones de sesion, modelos, chat-run y ops',
    ...
    new_0_6_18_6: 'La configuracion de desktop y runtime es mas segura con registro Unicode-safe del PATH en Windows, soporte para publicar runtime Yi Agent 0.17.0, metadata PWA movil y varias correcciones de recuperacion de profile/auth',
    ...
    new_0_6_13_5: 'Las actualizaciones de escritorio son mas fiables: las actualizaciones de Windows cierran procesos Yi Studio residuales, revisan Cloudflare primero y mantienen GitHub como feed de respaldo',
