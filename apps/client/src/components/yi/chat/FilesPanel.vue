...
import { useFilesStore } from '@/stores/yi/files'
import { useI18n } from 'vue-i18n'
import { NButton } from 'naive-ui'
import FileTree from '@/components/yi/files/FileTree.vue'
import FileBreadcrumb from '@/components/yi/files/FileBreadcrumb.vue'
import FileToolbar from '@/components/yi/files/FileToolbar.vue'
import FileList from '@/components/yi/files/FileList.vue'
import FileContextMenu from '@/components/yi/files/FileContextMenu.vue'
import FileEditor from '@/components/yi/files/FileEditor.vue'
import FilePreview from '@/components/yi/files/FilePreview.vue'
import FileUploadModal from '@/components/yi/files/FileUploadModal.vue'
import FileRenameModal from '@/components/yi/files/FileRenameModal.vue'
