export default {
  ...
  sidebar: {
    ...
    connected: 'Conectado',
    disconnected: 'Desconectado',
    updateTip: 'Execute "yi-web-ui update" no terminal para atualizar',
  ...
  runtimeVersions: {
    ...
    deleteRuntimeConfirm: 'Excluir Yi Runtime {version}?',
    ...
    activateSuccess: 'Seleção de versão salva. Reinicie o Yi Studio para usá-la.',
    jobStatus: {
      queued: 'Na fila',
      running: 'Em execução',
      completed: 'Concluída',
  ...
  chat: {
    ...
    contextEditHint: 'Valores comuns: 256k (Yi padrão), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Inicie uma conversa com o Yi Agent',
    ...
    hermesHistory: 'Histórico Yi',
    historyScopeHint: 'Sessões do histórico Yi do perfil atual, somente leitura, agrupadas por origem.',
    ...
    searchScope: 'Escopo da busca: apenas banco local de sessões da Web UI; sessões históricas Yi somente leitura não são incluídas.',
...
jobTriggered: 'Job acionado',
  ...
  skills: {
    ...
    writeApprovalDescription: 'Aprove ou rejeite escritas de memoria e skills preparadas pelo Yi Agent.',
    writeApprovalRefresh: 'Atualizar',
    writeApprovalEmpty: 'Nenhuma escrita pendente.',
    writeApprovalUnsupported: 'Esta versao do Yi Agent nao suporta revisao de escritas. Atualize o Yi Agent para usar este recurso.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Atualizar',
    notice: 'Inventário somente leitura dos manifests de plugins Yi detectáveis. Os metadados de descoberta são lidos sem carregar código de plugin. No v1, ações de gerenciamento ficam na CLI; mudanças entram em vigor em novas sessões Yi.',
  ...
  models: {
    ...
    copilotAddDetected: 'Foi detectado um token OAuth do GitHub Copilot nesta máquina. Clique em Adicionar para ativar o Copilot no Yi.',
    copilotAddSourceEnv: 'Origem: ~/.yi/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Origem: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Origem: extensão Copilot do VS Code (apps.json)',
    copilotDeleteHintEnv: 'Isto irá limpar o COPILOT_GITHUB_TOKEN em ~/.yi/.env. Outras ferramentas não são afetadas.',
    copilotDeleteHintGhCli: 'O Copilot ficará oculto no Yi. Sua sessão no gh CLI não é afetada — `gh auth status` continuará indicando que está conectado.',
    copilotDeleteHintAppsJson: 'O Copilot ficará oculto no Yi. A extensão Copilot do VS Code continuará conectada.',
    ...
    visibilityHint: 'Afeta apenas o seletor de modelos e a página de modelos da Web UI. A configuração provider/model da Yi CLI não é alterada; as chamadas ainda usam o ID original do modelo.',
    ...
    aliasHint: 'Altera apenas o nome exibido na Web UI. O Yi ainda recebe o ID original do modelo.',
    aliasEdit: 'Renomear',
  ...
  profiles: {
    ...
    rename: 'Renomear',
    delete: 'Excluir',
    switchTo: 'Trocar Yi Profile',
    switchConfirm: 'Isto executara `Yi Profile use {name}` e alterara o active profile do Yi CLI. Continuar?',
    switchSuccess: 'Yi active profile alterado para "{name}"',
    switchFailed: 'Falha ao trocar Yi Profile. O gateway pode precisar de reinicio manual.',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Controla quais gateways de perfis Yi locais a Web UI inicia durante a inicialização. Isto é salvo na configuração da Web UI, não no config.yaml do perfil.',
      ...
      managementHint: 'Requer Yi Agent 0.17.0 ou superior. Quando ativado, a Web UI grava multiplex_profiles para o gateway default servir todos os perfis; outros perfis nao podem configurar entradas de mensagens separadas como Feishu, Weixin ou QQBot. Ao desativar, remove essa configuração.',
    ...
    session: {
      ...
      memoryWriteApprovalHint: 'Colocar escritas de memoria do Yi Agent em aprovacao antes de salvar.',
      skillsWriteApproval: 'Revisar escritas de skills',
      skillsWriteApprovalHint: 'Colocar alteracoes de skills do Yi Agent em aprovacao antes de salvar.',
      writeApprovalTitle: 'Escritas pendentes de revisao',
      writeApprovalDescription: 'Aprove ou rejeite escritas de memoria e skills preparadas pelo Yi Agent.',
      writeApprovalRefresh: 'Atualizar',
      writeApprovalEmpty: 'Nenhuma escrita pendente.',
  ...
  codingAgents: {
    ...
    codexDescription: "CLI da OpenAI e fluxo de provedor openai-codex do Yi para tarefas de repositório.",
    copyCommand: "Copiar",
    commandCopied: "Comando copiado",
    ...
    installFailedHermesHint: "A instalação falhou. Peça ao Yi para instalar para você.",
    ...
    notes: {
      ...
      codexAuth: "Adiciona credenciais OAuth do OpenAI Codex gerenciadas pelo Yi.",
  ...
  platform: {
    ...
    weixinTokenHint: 'Do login QR da CLI weixin (yi weixin)',
  ...
  skillsUsage: {
    ...
    subtitle: 'Acompanhe carregamentos e edições de habilidades nas sessões Yi',
    refresh: 'Atualizar',
  ...
  changelog: {
    ...
    new_0_6_21_7: 'Headers de chat, group chat e workflow estao mais alinhados; Xiao Fang He mostra sold out; o escopo BSL ficou mais claro; o plano /learn foi documentado; o proxy Yi legado foi removido',
    ...
    new_0_6_18_2: 'Yi Studio MCP foi dividido em toolsets api, devices e use, com novas acoes de session, model, chat-run e ops',
    ...
    new_0_6_18_6: 'Desktop e runtime setup ficaram mais seguros com registro Unicode-safe do PATH no Windows, suporte a publicar runtime Yi Agent 0.17.0, metadata PWA movel e varias correcoes de profile/auth recovery',
    ...
    new_0_6_13_5: 'As atualizacoes desktop estao mais confiaveis: upgrades no Windows fecham processos Yi Studio residuais, verificam Cloudflare primeiro e mantem GitHub como feed de fallback',
