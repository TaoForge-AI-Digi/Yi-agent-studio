export default {
  ...
  sidebar: {
    ...
    expand: 'Expand menu',
    updateTip: 'Run "yi-web-ui update" in terminal to update',
  ...
  runtimeVersions: {
    ...
    deleteRuntimeConfirm: 'Delete Yi Runtime {version}?',
    ...
    activateSuccess: 'Version selection saved. Restart Yi Studio to use it.',
    jobStatus: {
      queued: 'Queued',
      running: 'Running',
      completed: 'Completed',
  ...
  chat: {
    ...
    contextEditHint: 'Common values: 256k (Yi default), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Start a conversation with Yi Agent',
    ...
    hermesHistory: 'Yi History',
    historyScopeHint: 'Read-only Yi History sessions for the current profile, grouped by source.',
    noSessions: 'No sessions',
    searchTitle: 'Search Sessions',
    searchSubtitle: 'Search by title or message content',
    searchScope: 'Search scope: Web UI local session database only. Read-only Yi History sessions are not included.',
  ...
  skills: {
    ...
    writeApprovalDescription: 'Approve or reject staged Yi Agent memory and skill writes.',
    writeApprovalRefresh: 'Refresh',
    writeApprovalEmpty: 'No pending writes.',
    writeApprovalUnsupported: 'This Yi Agent version does not support write approvals. Upgrade Yi Agent to use this feature.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Refresh',
    notice: 'Read-only inventory of discoverable Yi plugin manifests. Discovery metadata is read without loading plugin code. Management actions stay in CLI for v1; changes take effect in new Yi sessions.',
  ...
  models: {
    ...
    models: 'models',
    builtin: 'Built-in',
    selectProvider: 'Select a provider to view models',
    ...
    copilotAddDetected: 'A GitHub Copilot OAuth token was detected on this machine. Click Add to enable Copilot in Yi.',
    copilotAddSourceEnv: 'Source: ~/.yi/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Source: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Source: VS Code Copilot extension (apps.json)',
    copilotDeleteHintEnv: 'This will clear COPILOT_GITHUB_TOKEN in ~/.yi/.env. Other tools are not affected.',
    copilotDeleteHintGhCli: 'Copilot will be hidden from Yi. Your gh CLI login is not affected — `gh auth status` will still show you signed in.',
    copilotDeleteHintAppsJson: 'Copilot will be hidden from Yi. Your VS Code Copilot extension login is not affected.',
    ...
    aliasHint: 'Display-only alias. Yi still receives the canonical model ID.',
    ...
    visibilityHint: 'Only affects the Web UI model picker and Models page. Yi CLI provider/model config is not rewritten; calls still use canonical model IDs.',
  ...
  profiles: {
    ...
    rename: 'Rename',
    delete: 'Delete',
    switchTo: 'Switch Yi Profile',
    switchConfirm: 'This will run `Yi Profile use {name}` and change the active Yi CLI profile. Continue?',
    switchSuccess: 'Yi active profile switched to "{name}"',
    switchFailed: 'Failed to switch Yi Profile. Gateway may need manual restart.',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Control which local Yi Profile gateways the Web UI starts during startup. This is stored in the Web UI config, not a profile config.yaml.',
      ...
      managementHint: 'Requires Yi Agent 0.17.0 or later. When enabled, Web UI writes multiplex_profiles so the default gateway serves every profile; other profiles cannot configure separate Feishu, Weixin, QQBot, or similar messaging entrypoints. Turning it off removes that config.',
      managementAuto: 'Auto',
    ...
    session: {
      ...
      memoryWriteApprovalHint: 'Stage Yi Agent memory writes for approval before they are saved.',
      skillsWriteApproval: 'Review skill writes',
      skillsWriteApprovalHint: 'Stage Yi Agent skill changes for approval before they are saved.',
      writeApprovalTitle: 'Pending write approvals',
      writeApprovalDescription: 'Approve or reject staged Yi Agent memory and skill writes.',
      writeApprovalRefresh: 'Refresh',
      writeApprovalEmpty: 'No pending writes.',
  ...
  codingAgents: {
    ...
    codexDescription: "OpenAI CLI and Yi openai-codex provider flow for repository tasks.",
    copyCommand: "Copy",
    commandCopied: "Command copied",
    ...
    installFailedHermesHint: "Installation failed. Ask Yi to install it for you.",
    ...
    notes: {
      ...
      codexAuth: "Adds Yi-managed OpenAI Codex OAuth credentials.",
  ...
  platform: {
    ...
    weixinTokenHint: 'From weixin CLI QR login (yi weixin)',
  ...
  skillsUsage: {
    title: 'Skills Usage',
    subtitle: 'Track skill loads and edits from Yi sessions',
    refresh: 'Refresh',
  ...
  changelog: {
    ...
    new_0_6_21_3: 'The Yi Studio MCP use toolset can now list, create, update, delete, run, stop, delete runs, and rerun workflows from a selected node',
    ...
    new_0_6_21_7: 'Chat, group chat, and workflow headers are better aligned, the Xiao Fang He page now shows sold-out status, BSL license scope is clearer, the /learn integration plan is documented, and unused Yi proxy code was removed',
    ...
    new_0_6_18_2: 'Yi Studio MCP is split into focused api, devices, and use toolsets with new session, model, chat-run, and ops actions',
    ...
    new_0_6_18_6: 'Desktop and runtime setup are safer with Unicode-safe Windows PATH registration, Yi Agent 0.17.0 runtime publishing support, mobile PWA metadata, and several profile/auth recovery fixes',
    ...
    new_0_6_13_5: 'Desktop updates are more reliable: Windows upgrades close stale Yi Studio processes, Cloudflare is checked first, and GitHub remains the fallback feed',
  ...
  characters: {
    ...
    builtIn: 'Built-in',
    selectOrCreate: 'Select a character or create a new one',
    ...
    form: {
      ...
      soulPlaceholder: 'Define the agent personality, behavior, and system instructions...',
      userProfilePlaceholder: 'Define who the user is, their preferences, and context...',
      memoryPlaceholder: 'Long-term memory will be written here when enabled...',
      memoryEnabled: 'Enable memory',
      memoryOff: 'Off',
      memoryDisabledHint: 'Memory is disabled. Enable it to let the agent remember across sessions.',
    },
  },
}
