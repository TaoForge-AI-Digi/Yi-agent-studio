export default {
  ...
  sidebar: {
    ...
    connected: 'Connecte',
    disconnected: 'Deconnecte',
    updateTip: 'Executez "yi-web-ui update" dans le terminal pour mettre a jour',
  ...
  runtimeVersions: {
    ...
    deleteRuntimeConfirm: 'Supprimer Yi Runtime {version} ?',
    ...
    activateSuccess: 'Sélection de version enregistrée. Redémarrez Yi Studio pour l’utiliser.',
    jobStatus: {
      queued: 'En attente',
      running: 'En cours',
      completed: 'Terminé',
  ...
  chat: {
    ...
    contextEditHint: 'Valeurs courantes : 256k (Yi par défaut), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Demarrer une conversation avec Yi Agent',
    ...
    hermesHistory: 'Historique Yi',
    historyScopeHint: 'Sessions d’historique Yi du profil actuel en lecture seule, regroupées par source.',
    ...
    searchScope: 'Portée de recherche : base locale des sessions Web UI uniquement ; les sessions d’historique Yi en lecture seule ne sont pas incluses.',
...
jobTriggered: 'Job declenche',
  ...
  skills: {
    ...
    writeApprovalDescription: 'Approuvez ou refusez les ecritures de memoire et de skills preparees par Yi Agent.',
    writeApprovalRefresh: 'Actualiser',
    writeApprovalEmpty: 'Aucune ecriture en attente.',
    writeApprovalUnsupported: 'Cette version de Yi Agent ne prend pas en charge la validation des ecritures. Mettez Yi Agent a jour pour utiliser cette fonction.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualiser',
    notice: 'Inventaire en lecture seule des manifests de plugins Yi détectables. Les métadonnées de découverte sont lues sans charger le code des plugins. En v1, la gestion reste dans le CLI; les changements prennent effet dans les nouvelles sessions Yi.',
  ...
  models: {
    ...
    copilotAddDetected: 'Un token OAuth GitHub Copilot a été détecté sur cette machine. Cliquez sur Ajouter pour activer Copilot dans Yi.',
    ...
    copilotDeleteHintEnv: 'Cela supprimera COPILOT_GITHUB_TOKEN dans ~/.yi/.env. Les autres outils ne sont pas affectés.',
    copilotDeleteHintGhCli: 'Copilot sera masqué dans Yi. Votre connexion gh CLI n\'est pas affectée — `gh auth status` indiquera toujours que vous êtes connecté.',
    copilotDeleteHintAppsJson: 'Copilot sera masqué dans Yi. Votre extension Copilot de VS Code reste connectée.',
    ...
    visibilityHint: 'Affecte uniquement le sélecteur de modèles et la page Modèles de la Web UI. La configuration provider/model de Yi CLI n’est pas modifiée ; les appels utilisent toujours l’ID de modèle d’origine.',
    ...
    aliasHint: 'Modifie uniquement le nom affiché dans la Web UI. Yi reçoit toujours l’ID de modèle d’origine.',
    aliasEdit: 'Renommer',
  ...
  profiles: {
    ...
    rename: 'Renommer',
    delete: 'Supprimer',
    switchTo: 'Changer Yi Profile',
    switchConfirm: 'Cette action execute `Yi Profile use {name}` et change le active profile Yi CLI. Continuer ?',
    switchSuccess: 'Yi active profile change vers "{name}"',
    switchFailed: 'Echec du changement Yi Profile. La passerelle peut necessiter un redemarrage manuel.',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Contrôle les gateways de profils Yi locaux que la Web UI démarre au lancement. Cette option est stockée dans la configuration Web UI, pas dans le config.yaml du profil.',
    ...
    session: {
      ...
      memoryWriteApprovalHint: 'Mettre les ecritures de memoire de Yi Agent en attente de validation avant de les enregistrer.',
      skillsWriteApproval: 'Verifier les ecritures de skills',
      skillsWriteApprovalHint: 'Mettre les modifications de skills de Yi Agent en attente de validation avant de les enregistrer.',
      writeApprovalTitle: 'Ecritures en attente de validation',
      writeApprovalDescription: 'Approuvez ou refusez les ecritures de memoire et de skills preparees par Yi Agent.',
      writeApprovalRefresh: 'Actualiser',
      writeApprovalEmpty: 'Aucune ecriture en attente.',
  ...
  codingAgents: {
    ...
    codexDescription: "CLI OpenAI et flux fournisseur Yi openai-codex pour les tâches de dépôt.",
    copyCommand: "Copier",
    commandCopied: "Commande copiée",
    ...
    installFailedHermesHint: "L’installation a échoué. Demandez à Yi de l’installer pour vous.",
    ...
    notes: {
      ...
      codexAuth: "Ajoute les identifiants OAuth OpenAI Codex gérés par Yi.",
  ...
  platform: {
    ...
    weixinTokenHint: 'Depuis la connexion QR de la CLI weixin (yi weixin)',
  ...
  skillsUsage: {
    ...
    subtitle: 'Suivre les chargements et modifications de compétences dans les sessions Yi',
    refresh: 'Actualiser',
  ...
  changelog: {
    ...
    new_0_6_21_7: 'Les headers chat, group chat et workflow sont mieux alignes; Xiao Fang He affiche sold out; le scope BSL est clarifie; le plan /learn est documente; le vieux proxy Yi est supprime',
    ...
    new_0_6_18_2: 'Yi Studio MCP est separe en toolsets api, devices et use, avec de nouvelles actions session, model, chat-run et ops',
    ...
    new_0_6_18_6: 'La configuration desktop et runtime est plus sure avec un enregistrement PATH Windows compatible Unicode, le support de publication runtime Yi Agent 0.17.0, les metadonnees PWA mobile et plusieurs corrections profile/auth',
    ...
    new_0_6_13_5: 'Les mises a jour desktop sont plus fiables : les mises a niveau Windows ferment les anciens processus Yi Studio, Cloudflare est verifie en premier et GitHub reste le flux de secours',
