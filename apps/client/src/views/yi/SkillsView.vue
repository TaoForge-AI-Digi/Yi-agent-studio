...
import SkillList from '@/components/yi/skills/SkillList.vue'
import SkillDetail from '@/components/yi/skills/SkillDetail.vue'
import SkillImportModal from '@/components/yi/skills/SkillImportModal.vue'
import SkillExternalDirsModal from '@/components/yi/skills/SkillExternalDirsModal.vue'
import PendingWriteApprovals from '@/components/yi/skills/PendingWriteApprovals.vue'
import { fetchSkills, type SkillCategory, type SkillSource, type SkillInfo, type SkillTarget } from '@/api/yi/skills'
import { fetchPendingWrites } from '@/api/yi/write-gate'
